...
async function askQuestion() {
    ...
    switch (answers.operator) {
        case "Addition":
            {
                result = add(input1.numberOne, input2.numberTwo);
            }
            break;
        case "Subtraction":
            {
                result = sub(input1.numberOne, input2.numberTwo);
            }
            break;
        case "Multiplication":
            {
                result = mul(input1.numberOne, input2.numberTwo);
            }
            break;
        case "Division":
            {
                result = div(input1.numberOne, input2.numberTwo);
            }
            break;
    }
